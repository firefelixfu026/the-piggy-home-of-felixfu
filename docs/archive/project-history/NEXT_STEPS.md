...
完整启动、停止和排查步骤见 [DOCKER_COMPOSE.md](../../guides/DOCKER_COMPOSE.md)。
...
4. 如果准备部署上线，准备云服务器信息：
   ...
   - 域名，如果已有
5. 购买前先阅读 [CLOUD_SERVER_DOMAIN_PREP.md](../../guides/CLOUD_SERVER_DOMAIN_PREP.md)。
6. 真正开始部署时按 [CLOUD_SERVER_DEPLOYMENT.md](../../guides/CLOUD_SERVER_DEPLOYMENT.md) 执行。
